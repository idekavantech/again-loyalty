...
const reportConfig = {
  ...
  title: "The sum of the shipping cost",
  x_axis_node_title: "The sum of the shipping cost",
      ...
      headerTemplate: (
        ...
        >
          ...
          >
            ...
            >
              «Report the sum of the shipping cost»
            </div>
            {branches ? (
              <div
                style={{
...
AdminShipping.ShouldBeAdmin = true;
AdminShipping.Wrapper = AdminLayout;
