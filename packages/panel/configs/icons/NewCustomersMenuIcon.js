export default function NewCustomersMenuIcon({ style: { color } }) {
  return (
    <svg
      width="22"
      height="16"
    ...
    >
      <path
        d="M15.6699 9.12988C17.0399 10.0599 17.9999 11.3199 17.9999 12.9999V15.9999H21.9999V12.9999C21.9999 10.8199 18.4299 9.52988 15.6699 9.12988Z"
        fill={color}
      />
      <path
