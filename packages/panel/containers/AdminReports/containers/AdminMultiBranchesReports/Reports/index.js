            ...
            >
              ...
              <div className="d-flex justify-content-start align-items-center my-1">
                ...
                <Link
                  ...
                  target="_blank"
                >
                  گزارش تعداد کلی محصولات فروخته شده
                </Link>
              </div>
              <div className="d-flex justify-content-start align-items-center my-1">
                <AssessmentIcon className="ml-1" />
            ...
            >
              ...
              <div className="d-flex justify-content-start align-items-center my-1">
                ...
                <Link
                  ...
                  target="_blank"
                >
                  گزارش تراکنش‌های مالی فروش شعب براساس روش پرداخت
                </Link>
              </div>
              <div className="d-flex justify-content-start align-items-center my-1">
                <AssessmentIcon className="ml-1" />
            ...
            >
              <div className="d-flex justify-content-start align-items-center my-1">
                ...
                <Link
                  ...
                  target="_blank"
                >
                  گزارش کامل انبار مواد اولیه شعب
                </Link>
              </div>
              <div className="d-flex justify-content-start align-items-center my-1">
                <AssessmentIcon className="ml-1" />
              ...
              <div className="d-flex justify-content-start align-items-center my-1">
                ...
                <Link
                  ...
                  target="_blank"
                >
                  مشاهده نتایج انبارگردانی مواد اولیه شعب
                </Link>
              </div>
              <div className="d-flex justify-content-start align-items-center my-1">
                <AssessmentIcon className="ml-1" />
