...
function CRMLevels({ adminUrlPrefix, _getCrmLevels, allCrmLevels, isLoading  ,_deleteCrmLevel}) {
  useEffect(() => {
    setTimeout(() => {
      _getCrmLevels();
    }, 0);
  ...
  const navigateToLevelDetail = (e , id) => {
    ...
    router.push(`${adminUrlPrefix}crm/customer_levels/detail/${id}`);
  };
  ...
  return (
    <div className="container">
      ...
      <div className="d-flex align-items-center position-relative mb-5 ">
        ...
        >
          In this section you can create customer levels and information about each
          View the surface.
        </p>
      </div>
