...
const SEARCH_INTENT_SATISFYERS = [
  {
    id: 0,
    label: "سایت فروشگاهی",
    icon: "/images/bag-icon-white.svg",
  ...
  {
    id: 2,
    label: "نمونه سایت فروشگاهی",
    icon: "/images/Tick Square.svg",
    description: "",
    link: "/examples/shopping",
  },
  {
    id: 3,
    ...
    <main>
      <div className="position-relative">
        ...
        >
          ...
          >
            برای طراحی سایت فروشگاهی، چه چیزی مد نظر دارید؟
          </h2>
          <div
          ...
          >
            <div className="header-buttons d-flex  justify-content-center align-items-center  ml-2 ml-md-4">
              <Link href="/cr~templates">
                <button>ساخت فروشگاه اینترنتی</button>
              </Link>
            </div>
      ...
      >
        <div className="container">
          ...
          >
            مزیت طراحی سایت فروشگاهی ویترین
          </h2>
          <div
          ...
          >
            <div className="flex-1 position-relative">
              ...
              >
                ...
                >
                  با تکنولوژی I.O.M فروشگاه اینترنتی شما به ابزارهای اتوماسیون
                  بازاریابی مجهز می‌شود و به کمک آن می‌توانید مشتری‌های حضوری و
                  آنلاین خود را، از هر روشی که از شما خرید می‌کنند، دوباره
                  برگردانید و در نهایت فروش خود را بیشتر کنید. می‌دانستید به کمک
                  تکنولوژی I.O.M می‌توانید تا ۲۰۰٪ افزایش فروش آنلاین داشته
                  باشید؟!
                </p>
              </div>
              <div style={{ padding: "40px 0" }}>
                ...
                <p
                  ...
                  style={{ fontSize: 14, textAlign: "right" }}
                >
                  مدیریت سفارش‌ها، انبار، پیک‌ها و موارد دیگر بدون داشتن
                  ابزارهای درست، سخت و زمان‌بر است. با ویترین می‌توانید
                  کانال‌های فروش حضوری و آنلاین خود را یکپارچه کنید، روش‌های
                  پرداخت و ارسال متعدد داشته باشید و همیشه با همهٔ مشتری‌های خود
                  در ارتباط باشید.
                </p>
              </div>
              <Link
            ...
            <div className="flex-1 d-flex justify-content-center">
              <Image
                ...
                src="/images/1-Shopping.svg"
                width={maxWidth768 ? 320 : 533}
                alt="طراحی سایت فروشگاهی با ویترین به شما در فروش آنلاین کمک می‌کند."
              />
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          >
            <h2 className="font-weight-600">
              هر چیزی که از طراحی سایت انتظار دارید
            </h2>
          </div>
          <div
            className="d-flex flex-column flex-md-row"
          ...
          >
            <div className="flex-1 align-self-center">
              <Image
                src="/images/2-WebDesign.svg"
                width={maxWidth768 ? 320 : 533}
                height={maxWidth768 ? 240 : 400}
                alt=" طراحی سایت با ویترین بدون نیاز به کدنویسی انجام می‌شود."
              />
            </div>
            <div className="flex-1 position-relative">
              <div
              ...
              >
                <div className="d-flex align-items-center">
                  <Image
                    ...
                    height={24}
                    src="/images/edit-square-blue.svg"
                    alt="سایت فروشگاهی اختصاصی و مدیریت آسان"
                  />
                  <h3 className="mx-3 font-weight-600">
                    سایت فروشگاهی اختصاصی و مدیریت آسان{" "}
                  </h3>
                </div>
                <p
                  className="mt-4 pb-5"
                  style={{ fontSize: 14, textAlign: "right" }}
                >
                  طراحی سایت با ویترین، به لطف محیط کاربری سادهٔ آن، سریع و راحت
                  است و برای این کار نیازی به دانش فنی طراحی سایت ندارید. برای
                  مدیریت سایت فروشگاهی خود فقط به یک گوشی نیاز دارید! تمام
                  فرایندهای فروش مثل سفارش‌گیری یا گزارش‌ها، و تمام ویرایش‌های
                  ظاهری و محتوایی سایت، همگی از طریق گوشی شما قابل انجام است.
                </p>
              </div>
              <div style={{ padding: "40px 0" }}>
                <div className="d-flex align-items-center">
                  ...
                  />
                  <h3 className="mx-3 font-weight-600">
                    رعایت اصول سئو و طراحی واکنشگرا
                  </h3>
                </div>
                <p
                  className="mt-4 pb-5"
                  style={{ fontSize: 14, textAlign: "right" }}
                >
                  سایت‌های طراحی شده با ویترین همگی بر اساس اصول سئو عمل می‌کنند
                  که بالارفتن سایت شما در نتایج گوگل را سریع‌تر می‌کند. همچنین
                  استفاده از طراحی واکنشگرا (Responsive) در ویترین به زیباتر
                  دیده‌شدن سایت در گوشی و بهبود سئو سایت شما کمک می‌کند.
                </p>
              </div>
              <Link
                href="/cr~templates"
      ...
      <div style={{ backgroundColor: "#F6F6F7" }}>
        ...
        >
          ...
          >
            فروشگاه اینترنتی خود را با سلیقه طراحی کنید
          </p>
          <p
            className={`pt-4 ${maxWidth768 ? "mb-0" : " mb-5"}`}
            style={{ fontSize: 14, lineHeight: "24px", textAlign: "center" }}
          >
            برای طراحی سایت فروشگاهی خودتان می‌توانید با یک قالب سایت فروشگاهی
            شروع کنید و بعد، هر صفحه از سایت فروشگاه خودتان را به دلخواه تغییر
            دهید و اجزای مختلف را کنار هم بچینید.
          </p>
          <Image
            height={maxWidth768 ? 232 : 438}
            width={maxWidth768 ? 342 : 600}
            className="mt-4"
            src="/images/3-Templates.svg"
            alt="طراحی وبسایت‌های فروشگاهی با ویترین بسیار سریع است"
          />
        </div>
      </div>
      <div
      ...
      >
        ...
        >
          راهنمای شروع طراحی سایت فروشگاهی
        </h2>
        <div
      ...
      >
        <div className="container">
          ...
          >
            نمونه سایت‌های فروشگاهی دیگران را ببینید
          </p>
          <p
            className="pt-4"
            style={{ fontSize: 14, lineHeight: "24px", textAlign: "center" }}
          >
            انواع مختلف نمونه سایت فروشگاهی که با ویترین طراحی شده‌اند را ببینید
            و از قابلیت‌های مختلف ویترین برای طراحی فروشگاه اینترنتی خودتان
            استفاده کنید.
          </p>
          <p
      ...
      />
      <BreadCrumb text="طراحی سایت فروشگاهی" link={router.asPath} />
      <Footer />
    </main>
  );
}
