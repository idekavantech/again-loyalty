...
import { bcn } from "utils/constants/PAGES";
...
function BusinessPage({
  ...
  const breadCrumbItems = [
    data.v2,
    data.isShopping ? data.xsb1 : data.xb1,
    data.isShopping ? data.xsbc1 : data.xbc1,
  ];
    ...
    <main>
      <div className="position-relative">
        ...
        <Section1
          ...
          name={data.nameFaBusiness}
          city={data.nameFaCity}
          image={data.image1}
      ...
      <Section2
        typeOfLanding={"city"}
        isShopping={false}
        name={data.nameFaCity}
        businessName={data.nameFaBusiness}
        v1={getVariable(data.v1)}
        v3={getVariable(data.v3)}
        v5={getVariable(data.v5)}
        v6Text={data.v6.text}
        v8={getVariable(data.v8)}
        xsbc1={getVariable(data.xsbc1)}
        xbc1={getVariable(data.xbc1)}
      ...
      <Section2
        ...
        name={data.nameFaBusiness}
        image={data.image3}
        nameOfBusiness={data.nameBusiness}
      ...
      <Section4
        ...
        xsbc2={getVariable(data.xsbc2)}
        xbc2={getVariable(data.xbc2)}
      />
      <Section5 />
      <Section6
        typeOfLanding={data.typeOfLanding}
      ...
      <Section7
        ...
        nameOfCity={data.nameFaCity}
        xsbc3={getVariable(data.xsbc3)}
        xbc3={getVariable(data.xbc3)}
      />
      ...
      <Section8
        ...
        xb2={getVariable(data.xb2)}
        v37={getVariable(data.v37)}
        xsbc4={getVariable(data.xsbc4)}
        xbc4={getVariable(data.xbc4)}
      />
      {/* Section9 (Mobile) */}
      <div
        className="d-md-none"
          ...
          <div className="container">
            ...
            >
              ...
              <div className="w-100 flex-1 d-flex flex-column justify-content-between m-0 mr-md-4">
                ...
                {data.isShopping ? (
                  <p className="mt-4">
                    تیم ویترین آماده است برای {getVariable(data.xc1)} به
                    کسب‌وکار شما انواع خدمات طراحی {getVariable(data.xsb2)} و
                    مشاوره‌های مرتبط را در اختیار شما قرار دهد. از طریق پر کردن
                    فرم مشاوره زیر یا تماس با شماره تلفن ۰۲۱۹۱۰۷۰۷۵۱ پاسخگوی شما
                    هستیم.
                  </p>
                ) : (
                  <p className="mt-4">
                    اگر به دنبال {getVariable(data.xc1)} برای کسب‌وکار{" "}
                    {data.nameFaBusiness} خودتان نیاز به مشاوره دارید، لطفا با
                    تیم پشتیبانی ویترین تماس بگیرید تا از انواع خدمات{" "}
                    {getVariable(data.v4)} ویترین اطلاع پیدا کنید. برای این کار
                    می‌توانید فرم مشاوره زیر را پر کنید یا با شماره تلفن
      ...
      <Section10
        title={`لینک‌های مرتبط با طراحی سایت ${data.nameFaBusiness} در ${data.nameFaCity}`}
      ...
      >
        {bcn
          .filter(
            (item) => item.show && item.english.business === data.nameBusiness
          )
          .map((item) => {
            return (
              <p key={item.id}>
                <Link
                  href={`/bc/${item.english.business}~${item.english.city}`}
                  style={{ color: "#0050FF" }}
                >
                  طراحی سایت {item.persian.business} در {item.persian.city}
                </Link>
              </p>
            );
          })}
