...
import { oceanI } from "utils/colors";
import uniqueId from "lodash/uniqueId";
import useTheme from "@material-ui/core/styles/useTheme";
import Link from "next/link";
import { content, customization } from "./constant";
...
const SlideWrapper = ({
  ...
  if (slide_link_type === "external" && slide_external_link[0] === "#") {
    return (
      <Link
        passHref
        href={slide_external_link || slide_link}
        className={className}
        style={{ display: "block" }}
      >
        {children}
    ...
    <Link
      ...
      href={
        slide_link_type === "internal"
          ? slide_internal_link || slide_link
          : slide_external_link || slide_link
      }
      className={className}
      style={{ display: "block" }}
      target="_blank"
...
function Slider1({ business, selectedItemIndex = 0 }) {
  const { minWidth992, maxWidth992 } = useResponsive();
  ...
  const {
    ...
    framing: {
      ...
      border_color_in_desktop = oceanI,
  ...
  slides;
  const hasStaticHeight = minWidth992
    ? !use_ratio_height_in_desktop
  ...
  const contentLocationStyles = useMemo(() => {
    ...
    return {
      ...
      center_right: {
        top: "50%",
        right: hasBorderWidth ? `calc(6% + ${borderWidth}px)` : "6%",
                ...
                return (
                  <div
                    className={`px-${space_between_slides || 0} h-100 ${
                      minWidth992 ? desktopClass : mobileClass
                    }`}
                  >
                    <SlideWrapper
                      ...
                      className={minWidth992 ? desktopClass : mobileClass}
                    >
                      <div
                ...
                return (
                  <div className={`px-${space_between_slides || 0}`}>
                    ...
                    >
                      ...
                      >
                        <div
                          className={minWidth992 ? "col-lg-6 h-100" : "col-12"}
                        >
                          <img
                            className="w-100"
                            style={{
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {is_title_visible && (
                            <p
                              className={`${minWidth992 ? "my-lg-4" : ""} mb-4`}
                              style={{
                                color: slide_title_use_theme_color
                                  ? theme.palette.secondary.main
                                  : slide_title_color,
                        ...
                        <div
                          className={`${
                            minWidth992 ? "col-lg-6 h-100" : "col-12"
                          }`}
                        >
                          <img
                            className="w-100"
