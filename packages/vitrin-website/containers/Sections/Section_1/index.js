...
import { business, content, customization, id } from "./constant";
...
function Type3() {
  ...
  const { minWidth768, minWidth992, maxWidth768 } = useResponsive();
  ...
  return (
    <Paper elevation={1}>
        ...
        dangerouslySetInnerHTML={{
          __html: `
            #${id}{
                ...
                width: 100%;
                height:  fit-content;
                display: ${minWidth992 ? "flex" : "block"};
      ...
      <div id={id}>
        ...
        <div
          className={`${
            minWidth992 ? "flex-lg-row" : "flex-column"
        ...
        >
          ...
          <div
            ...
            style={{ width: minWidth992 ? "50%" : "100%" }}
          >
            <div>
              {is_animation_visible && animation_value && (
                <div
                  style={{ minHeight: 65 }}
                  className={minWidth992 ? "mb-lg-3" : ""}
                >
                  <Typist
