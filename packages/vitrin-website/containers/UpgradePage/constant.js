...
export const customers_comments_slider_setting = {
  className: "center",
  centerMode: true,
  infinite: true,
  centerPadding: "31%",
...
export const vitrin_possibilities = [
  ...
  },
  {
    ...
    description:
      "ویترین راهکارهای افزایش فروش مختلف را آزموده و بهترین آن‌ها را به کسب‌وکارها پیشنهاد می‌دهد. در ویترین می‌توانید به کانال‌های جذب مشتری ترب، بهترینو، ایمالز، قیمت و پلتفرم‌های تبلیغاتی متصل شوید.",
  },

  {
    ...
    description:
      "با استفاده از ویدئوهای آموزشی ویترین و بدون نیاز به کدنویسی می‌توانید سایت خود را بسازید. هر سؤالی داشته باشید می‌توانید از پشتیبانی ویترین بپرسید.",
  },
  {
    id: uniqueId(),
    ...
    description:
      "تا امروز بیش از ۱۰۰۰ کسب‌وکار در صنف‌های مختلف به ویترین اعتماد کرده‌اند و در طراحی سایت و فروشگاه اینترنتی خود از خدمات ویترین استفاده می‌کنند.",
  },
];
...
export const vitrin_features = [
  ...
  },
  {
    ...
    description:
      "برای داشتن یک سایت حرفه‌ای، ابتدا اطلاعات مهم کسب‌وکارتان مثل نام، آدرس و شماره تماس را تکمیل کنید. سپس می‌توانید تنظیماتی مثل اتصال به دامنه دلخواه، درگاه پرداخت آنلاین، اینماد و موارد دیگر را مطابق با آموزش‌ها انجام دهید. در این مرحله زیرساخت فعالیت آنلاین شما آماده شده است!",
  },
  {
    id: uniqueId(),
    number: 4,
    ...
    description:
      "قدم بعدی افزودن محصولات و محتوا به سایت است. محصولاتی که می‌فروشید، قلب فروشگاه اینترنتی شماست. توضیحات و تصاویر هر محصول را با جزئیات وارد کنید. اگر فروش آنلاین ندارید، روی تولید محتوا و تصاویر جذاب وقت بگذارید.",
  },
  {
    id: uniqueId(),
    number: 5,
    ...
    description:
      "حالا سایت یا فروشگاه اینترنتی شما آماده موفقیت است! در تمام مسیر از پشتیبانی فنی ویترین بهره‌مند هستید. هر سؤالی که داشته باشید می‌توانید با پشتیبانی ویترین تماس بگیرید.",
  },
  {
    id: uniqueId(),
    number: "+",
    title: "طراحی اختصاصی، راه‌اندازی سایت و سئو",
    description:
      "اگر در فروش آنلاین مصمم هستید و می‌خواهید به‌سرعت یک سایت حرفه‌ای و شیک داشته باشید، می‌توانید برای طراحی سفارشی صفحات سایت، هویت بصری و بهینه‌سازی سایت با کارشناسان ویترین صحبت کنید تا چند پله جلو بیفتید!",
  },
];
export const pricing_package = [
  {
    ...
    title: "بسته حرفه ای",
    type: "professional",
    subTitle: "مناسب فروشگاه‌های بزرگ",
    price: 997,
    color: "#33CBF4",
    ...
    features: [
      {
        id: uniqueId(),
        title: "یکپارچگی با باشگاه مشتریان",
        description:
          "امکان اتصال خودکار سفارش‌ها و مشتریان سایت شما به باشگاه مشتریان اختصاصی. هزینه باشگاه مشتریان جداگانه محاسبه می‌شود.",
      },
      {
        id: uniqueId(),
        title: "یکپارچگی با نرم‌افزار صندوق فروشگاهی",
        description:
          "امکان اتصال و تجمیع خودکار سفارش‌ها، تراکنش‌ها و اطلاعات مشتریان سایت با نرم‌افزار فروش حضوری کسب وکار شما. هزینه نرم‌افزار صندوق فروشگاهی جداگانه محاسبه می‌شود.",
      },
      {
        id: uniqueId(),
        title: "۳۰۰ هزارتومان شارژ هدیه در سایت بهترینو ",
        description:
          "۳۰۰ هزارتومان شارژ هدیه تبلیغات در سایت بهترینو برای معرفی کسب‌وکار شما به بازدیدکنندگان",
      },
      {
        id: uniqueId(),
        title: "پیامک هدیه برای ۱۰۰۰ سفارش اول ",
        description:
          "پیامک‌های اطلاع‌رسانی دریافت، تأیید و ارسال سفارش، پیامک نظرسنجی و اعتبار هدیه به مشتریان شما",
      },
      { id: uniqueId(), title: "کارمزد ۰.۴٪", description: "به ازای هر فروش" },
    ],
  },
  {
    id: uniqueId(),
    icon: "/images/loyalty.svg",
    ...
    features: [
      ...
      {
        id: uniqueId(),
        title: "پیامک هدیه برای ۱۰۰ سفارش اول",
        description:
          "پیامک‌های اطلاع‌رسانی دریافت، تأیید و ارسال سفارش، پیامک نظرسنجی و اعتبار هدیه به مشتریان شما",
      },
      { id: uniqueId(), title: "کارمزد ۱.۲٪", description: "به ازای هر فروش" },
    ],
  },
  {
    id: uniqueId(),
    icon: "/images/offline-pin.svg",
    title: "بسته پایه",
    ...
    features: [
      {
        id: uniqueId(),
        title: "سیستم کامل فروش آنلاین",
        description:
          "زیرساخت یک فروشگاه آنلاین کامل با امکان اتصال به کانال‌های مختلف فروش، سرویس‌های ارسال مختلف و درگاه پرداخت اختصاصی",
      },
      { id: uniqueId(), title: "بدون نیاز به کدنویسی" },
      { id: uniqueId(), title: "سئوی فنی خودکار" },
      { id: uniqueId(), title: "کارمزد ۳.۶٪", description: "به ازای هر فروش" },
    ],
  },
];
