...
import {
  ...
  pricing_package,
  ONE_YEAR,
} from "containers/UpgradePage/constant";
...
const PricingPage = ({ isAuthenticated }) => {
  ...
  const [isOpenLeadMagnet, setIsOpenLeadMagnet] = useState(false);
  ...
  useEffect(() => {
    ...
    if (!localStorage.getItem("Login") && !isAuthenticated) {
      const _id = setTimeout(() => {
        setIsOpenLeadMagnet(true);
        window.dataLayer.push({
          event: "open_lead_magnet_modal",
        });
      }, 12000);
      setTimeOutId(_id);
    }
    ...
    <div className="position-relative">
      ...
      <div className="upgrade-contianer">
        <div>
              ...
              <div className="d-flex align-items-center mt-5 position-relative timing-tabs">
                <div
                  className={`flex-1 d-flex align-items-center justify-content-center cursor-pointer  tab-one ${
                    selectedTime == "oneYear" ? "active-tab" : ""
                  }`}
                  onClick={() => setSelectedTime("oneYear")}
                >
                  <p>یکساله</p>
          ...
          <div className="d-none w-100 d-md-flex flex-column align-items-center">
            ...
            >
              {pricing_package?.map((pack, index) => (
                ...
                >
                  <Image width={24} height={24} src={pack.icon} />
                  <p
                    className="mt-2"
                    style={{
                      color: pack.color,
          ...
          <div
            className="container d-md-none w-100 my-4 d-flex justify-content-center cursor-pointer"
            style={{ color: "#0050FF", fontSize: 15, fontWeight: 500 }}
            onClick={() => setIsOpenCollapse(!isOpenCollapse)}
          >
            <span className="ml-1">مشاهده جزئیات بسته‌ها</span>
              ...
              <div className="w-100 d-flex justify-content-between mt-5 pt-5">
                ...
                >
                  ...
                  >
                    ...
                    >
                      درآمد آنلاین کسب‌وکارهایی که سایت خود را با ویترین
                      ساخته‌اند
                    </p>
                    <p
                      className="mt-1"
              ...
              <div className="d-flex justify-content-between align-items-center">
                ...
                >
                  ...
                  <p className="mt-4 pb-5 text-right" style={{ fontSize: 15 }}>
                    ...
                    تجربه است. اگر برای راه‌اندازی وبسایت کسب‌وکارتان می‌خواهید
                    از تخصص و سلیقه افراد حرفه‌ای استفاده کنید، می‌توانید روی
                    ویترین حساب کنید.
                  </p>
                  <button
                    className="mt-5"
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  >
                    ...
                    <p
                      className="mt-4 pb-5 text-right"
                      style={{ fontSize: 15 }}
                    >
                      اگر برای طراحی سایت کسب‌وکارتان نیازمندی ویژه‌ای دارید که
                      در جزئیات بسته‌ها پیدا نکردید، می‌خواهید بعضی از خدماتی که
                      در لیست قیمت طراحی سایت آمده را متناسب با کسب‌وکار خودتان
                      تغییر دهید یا هر سؤال دیگری درباره تعرفه ساخت سایت و
                      فروشگاه اینترنتی دارید، می‌توانید با کارشناسان ویترین صحبت
                      کنید.
                    </p>
                    <button
                      className=" mt-5"
            ...
            >
              ...
              >
                <Slider {...customers_comments_slider_setting}>
                  {CUSTOMER_COMMENTS.map((customer, index) => (
                    <div key={customer.id}>
                      <div
                        className="d-flex flex-column  align-items-center"
                        style={{
      ...
      <LeadMagnet
        isOpen={isOpenLeadMagnet}
        onClose={() => setIsOpenLeadMagnet(false)}
      />
    </div>
  );
};
