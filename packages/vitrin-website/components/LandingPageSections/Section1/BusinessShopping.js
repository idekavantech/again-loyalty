...
function Section1OfBusinessShopping({
  refToExamples,
  refToPossibilities,
  formattedGmv,
  sbm,
  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          {cn ? `طراحی سایت ${sbm} در ${cn}` : `طراحی سایت ${sbm}`}
        </h1>
        <h2
          className="text-center"
          style={{
        ...
        >
          ساخت سایت و فروشگاه اینترنتی {sbm} با ویترین
        </h2>
        <h2
          className="text-center"
          style={{
        ...
        >
          <Image
            ...
            width="300px"
            height="280px"
            alt={`یک کسب‌وکار که برای طراحی سایت ${sbm} از سایت ساز ویترین استفاده کرده است.`}
          />
        </div>
      </div>
      {/* (Desktop) */}
...
Section1OfBusinessShopping.propTypes = {
...
export default memo(Section1OfBusinessShopping);
