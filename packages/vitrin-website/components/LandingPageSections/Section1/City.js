  ...
  return (
    <Fragment>
      ...
      >
        ...
        >
          {`ساخت سایت و فروشگاه اینترنتی در ${cn} با ویترین`}
        </h2>
        <h2
          className="text-center"
          style={{
        ...
        >
          <Image
            ...
            width="300px"
            height="280px"
            alt={`سایت ساز ویترین در ${cn} هم طراحی سایت انجام می‌دهد.`}
          />
        </div>
      </div>
      {/* (Desktop) */}
...
export default memo(Section1OfCity);
