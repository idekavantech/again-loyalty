...
import { getVitrinPossibilitiesOfBusinessNoShopping } from "./constant";
import Image from "next/image";

function Section3OfBusinessNoShopping({
  refOfPossibilitiesMobile,
  openCollapse,
  onToggleCollapse,
  site,
  ibt,
}) {
  const vitrinPossibilities = useMemo(
    () => getVitrinPossibilitiesOfBusinessNoShopping({ site, ibt }),
    [site, ibt]
  );
      ...
      >
        <div className="container">
          <h2 style={{ fontSize: 16, fontWeight: 500 }}>
            امکانات حرفه‌ای سایت ساز ویترین را بشناسید
          </h2>
...
Section3OfBusinessNoShopping.propTypes = {
...
export default memo(Section3OfBusinessNoShopping);
