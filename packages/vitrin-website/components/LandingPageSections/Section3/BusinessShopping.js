...
import {getVitrinPossibilitiesOfBusinessShopping} from "./constant"
import Image from "next/image";

function Section3OfBusinessShopping({refOfPossibilitiesMobile, openCollapse, onToggleCollapse, v6, xsb2, shop2}) {
  const vitrinPossibilities = useMemo(() => getVitrinPossibilitiesOfBusinessShopping({xsb2, shop2}), [xsb2, shop2]);
  ...
  return <Fragment>
    ...
    >
      <div className="container">
        ...
        امکانات ویترین را برای {v6} بشناسید
        </h2>
...
Section3OfBusinessShopping.propTypes = {
...
export default memo(Section3OfBusinessShopping)