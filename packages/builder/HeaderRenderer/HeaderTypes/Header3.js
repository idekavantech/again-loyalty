...
import { tiramisoo, vanilla } from "@saas/utils/colors";
        ...
        <div id="header_3">
          <div className="w-100 d-flex flex-1 p-3">
            ...
            {_HEADER_SEARCH_VISIBILITY ? (
              ...
              >
                <div
                  className="px-3 py-1 u-cursor-pointer d-flex align-items-center"
                  style={{
                    width: 354,
          ...
          <div
            style={{
              background: vanilla,
              borderTop: `1px solid ${tiramisoo}`,
              borderBottom: `1px solid ${tiramisoo}`,
              minHeight: 46,
            }}
            className="px-3 py-1 d-flex position-relative"
          >
...
export default compose(withConnect, memo)(Header3);
