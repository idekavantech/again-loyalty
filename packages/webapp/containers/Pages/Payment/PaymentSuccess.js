...
function SuccessPayment({
  ...
  const isDeliveryInterval = order?.delivery_interval?.to_time;
  ...
  const deliveryTimeOptions = {
    [DELIVERY_TIME]: !isDeliveryInterval
      ? deliveryTime > 10800
        ? deliveryTimeFormatter(deliveryInterval.from_time)
        : englishNumberToPersianNumber(timer)
      : null,
    [DELIVERY_INTERVAL]: isDeliveryInterval
