  ...
  produce(state, (draft) => {
    switch (action.type) {
      case START_REPORT_LOADING:
        draft.reportsLoading[action.data.name] = true;
        break;
      case STOP_REPORT_LOADING:
        draft.reportsLoading[action.data.name] = false;
        break;
      case START_LOADING:
      ...
      case SET_HAS_ERROR:
        draft.message = action.data.hasError;
        draft.hasError[action.data.name] = true;
        break;
    }
  });
